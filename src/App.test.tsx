...
describe('OHKO tests, Official Strats', () => {
  const testCases = [
    ...
    { name: 'serperior/main', path: 'serperior/main.json' },
    { name: 'serperior/cooking_w_gas_3', path: 'serperior/cooking_w_gas_3.json' },
    { name: 'infernape/main', path: 'infernape/main.json' },
    { name: 'infernape/rock_all_night_3', path: 'infernape/rock_all_night_3.json' },
  ];
...
describe('OHKO tests, Alternative Strats', () => {
  const testNames = [
    ...
    "serperior/cooking_w_monkey",
    "serperior/anger_point",
    "serperior/braviary",
    "serperior/spiced_snake",
    "serperior/eeveelutions",
    "serperior/cold_blooded",
    "serperior/godzilla",
    "serperior/steely_swagger",
    "serperior/zen_and_psy",
    "serperior/sunny_puppies",
    "serperior/knuckle_sandwich",
    "serperior/buzz_worthy",
    "serperior/spider_vs_serpent",
    "serperior/team_smelly",
    "serperior/noxious_fumes",
    "serperior/danger_noodles",
    "serperior/snake_pit",
    "serperior/all_seviper",
    "serperior/strange_bedfellows",
    "serperior/sneasel_family_fun",
    "serperior/foreign_exchange",
    "serperior/power_struggle",
    "serperior/volcanic_activity",
    "serperior/sizzlin_lizards",
    "serperior/cold_competition",
    "serperior/air_raids",
    "serperior/eye_of_the_storm",
    "serperior/reflected_strength",
    "serperior/mythicals",
    "serperior/nukebro",
    "serperior/nukebro_hard_mode",
    "serperior/gunkbro",
    "serperior/cooking_w_bunny",
    "serperior/ironworking_infants",
    "infernape/steely",
    "infernape/anger_point",
    // "infernape/passimian", // Todo: investigate this test-only failure
    "infernape/monkey_business",
    "infernape/fish_food",
    "infernape/basculegion",
    "infernape/quaquaval",
    "infernape/critdra",
    "infernape/coordinated",
    "infernape/licence_to_raid",
    "infernape/yellow",
    "infernape/eeveelutions",
    "infernape/playing_with_fire",
    "infernape/godzilla",
    "infernape/zen_and_psy",
    "infernape/full_moon_frolicking",
    "infernape/full_moon_fury",
    "infernape/bananas",
    "infernape/tea_in_kitakami",
    "infernape/planet_of_the_apes",
    "infernape/be_water_my_friend",
    "infernape/speedy_fish",
    "infernape/water_starters",
    "infernape/colorful_reflections",
    "infernape/attack_of_the_sea_angels",
    "infernape/mythicals",
    "infernape/legendary_babies",
    "infernape/beach_bash",
    "infernape/tsunami_tykes",
    "infernape/squirtle_and_friends",
  ];
